...
- [ ] Create Sales Kits through the existing tracked-share service.
- [ ] Track published, shared, clicked, ordered, fulfilled, refunded, and net-earned progress.
- [ ] Give rule-based next-best actions; AI may rewrite copy but cannot change economics.
- [ ] Add the goal form, recommendations, plan, and progress to the Earn Network UI.
  - [x] Goal form, economics-based recommendation input, and seven-day plan UI.
  - [ ] Fulfilled net-earnings progress and next-action controls.
...
2. Goal dashboard integrated into the existing Earn Network screen.
3. Goal progress from existing Sales Shares, conversions, fulfillments, and splits.
