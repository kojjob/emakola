      ...
      <div class="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
          <nav class="hidden md:flex items-center gap-6 text-sm text-[#6B7280] flex-1">
            ...
            <a href={"/@#{@store.slug}/products"} class="hover:text-[#1A1A1A]">New</a>
            <a href={"/@#{@store.slug}/about"} class="hover:text-[#1A1A1A]">About</a>
          </nav>
          <a
            href={"/@#{@store.slug}"}
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul class="space-y-2 text-sm text-[#6B7280]">
              <li>
                <a href={"/@#{@store.slug}/products"} class="hover:text-[#1A1A1A]">
                  All products
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul class="space-y-2 text-sm text-[#6B7280]">
              ...
              <li>
                <a href={"/@#{@store.slug}/track"} class="hover:text-[#1A1A1A]">
                  Track order
                </a>
              </li>
            </ul>
