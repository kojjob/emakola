defmodule Emakola.Themes.Atelier.About do
  ...
  def render(assigns) do
    ...
    <div class="atelier-body">
      ...
      <%!-- Hero Section --%>
      <section class="relative overflow-hidden" style="background: var(--theme-accent);">
          ...
          <div class="max-w-3xl">
            ...
            <p class="text-lg sm:text-xl text-white/80 leading-relaxed max-w-2xl">
              {if @store.description,
                ...
                else: "We believe in the power of artisan craft to connect communities, preserve traditions, and create beauty that transcends borders."}
            </p>
          </div>
        </div>
        <%!-- Decorative pattern --%>
  ...
  defp step_icon(%{name: "search"} = assigns) do
    ~H"""
    <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" style="color: var(--theme-primary);">
  ...
  defp step_icon(assigns) do
    ~H"""
    <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" style="color: var(--theme-primary);">
  ...
  defp value_icon(%{name: "shield"} = assigns) do
    ~H"""
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" style="color: var(--theme-primary);">
  ...
  defp value_icon(assigns) do
    ~H"""
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" style="color: var(--theme-primary);">
      <circle cx="12" cy="12" r="10" />
    </svg>
    """
  end
