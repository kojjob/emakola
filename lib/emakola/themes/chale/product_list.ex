defmodule Emakola.Themes.Chale.ProductList do
  ...
  def render(assigns) do
    ...
    <div class="border-b border-[#E3E0DA] bg-[#F7F5F1]">
      <div class="mx-auto max-w-[1280px] px-4 py-10 sm:px-6 sm:py-14 lg:px-8">
        <h1 class="text-5xl font-bold uppercase leading-[0.95] tracking-tight text-[#101114] [font-family:var(--chale-display)] sm:text-7xl">
          Shop all
        </h1>
    ...
    <div class="mx-auto max-w-[1280px] px-4 pb-24 pt-6 sm:px-6 sm:pt-8 lg:px-8">
      <div class="mb-6 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        ...
        <div class="flex items-center gap-2 overflow-x-auto pb-1 [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden">
          <button
            ...
            class={[
              "flex-shrink-0 cursor-pointer rounded-xl border border-[#E3E0DA] px-4 py-2 text-xs font-bold uppercase tracking-widest focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#2547E8] focus-visible:ring-offset-2 motion-safe:transition-colors",
              if(is_nil(@selected_category),
                do: "bg-[#101114] text-white",
                else: "bg-white text-[#101114] hover:bg-[#F7F5F1]"
              )
            ]}
          >
            All
        ...
        <form phx-change="search" class="w-full lg:max-w-xs">
          ...
          <input
            ...
            phx-debounce="300"
            class="w-full rounded-xl border border-[#E3E0DA] bg-white px-4 py-2.5 text-sm text-[#101114] placeholder-zinc-400 focus:outline-none focus:ring-2 focus:ring-store-accent"
          />
        </form>
      </div>
      ...
      <div
        id="product-list"
        phx-update="stream"
        class="grid grid-cols-2 gap-4 sm:gap-5 md:grid-cols-3 lg:grid-cols-4 lg:gap-6"
      >
        <div
          id="product-list-empty"
          class="col-span-full hidden border-2 border-dashed border-zinc-400 bg-white px-6 py-16 text-center only:block sm:py-20"
        >
          <h2 class="text-2xl font-bold uppercase tracking-tight text-[#101114] [font-family:var(--chale-display)] sm:text-3xl">
            Nothing here, chale
          </h2>
          ...
          <button
            ...
            phx-click="filter_category"
            phx-value-category_id="all"
            class="mt-6 inline-flex cursor-pointer items-center rounded-xl bg-white px-6 py-2.5 text-xs font-bold uppercase tracking-widest text-[#101114] hover:bg-[#101114] hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#2547E8] focus-visible:ring-offset-2 motion-safe:transition-colors"
          >
            Clear all filters
          </button>
        </div>
      ...
      <div :if={@has_more} class="mt-10 text-center">
        <button
          type="button"
          phx-click="load_more"
          class="inline-flex cursor-pointer items-center gap-2 rounded-xl border border-[#E3E0DA] bg-white px-8 py-3 text-xs font-bold uppercase tracking-widest text-[#101114] shadow-sm hover:bg-[#F7F5F1] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#2547E8] focus-visible:ring-offset-2 motion-safe:transition-colors motion-safe:active:translate-y-0.5"
        >
          Load more
          <svg
            class="h-4 w-4"
