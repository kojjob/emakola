defmodule Emakola.Themes.DefaultRenderers.BlogList do
  @moduledoc """
  Default render for the storefront blog list page.

  Used by `EmakolaWeb.Storefront.BlogListLive` when no theme overrides
  `:render_blog_list`. See `docs/PATTERN-default-renderer-extraction.md`
    ...
    <div class="bg-stone-50">
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div :if={@featured} class="mt-8 sm:mt-10 mb-8 sm:mb-10">
          <a
            href={"/@#{@store.slug}/blog/#{@featured.slug}"}
