  ...
  def render(assigns) do
    ...
    <!-- Checkout Button -->
              ...
              <a
                ...
                class="mt-3 flex items-center justify-center gap-2 w-full h-12 bg-whatsapp text-white text-sm font-semibold rounded-xl hover:bg-whatsapp-dark transition-colors cursor-pointer focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-whatsapp focus-visible:outline-none"
              >
