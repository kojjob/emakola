      ...
      <div class="max-w-[640px] mx-auto px-4 -mt-6 sm:-mt-8 pb-12 relative z-10">
        ...
        <div class="space-y-3 mb-6">
          ...
          <a
            ...
            class="group w-full flex items-center justify-center gap-2.5 px-8 py-4 bg-white border border-[#E7E5E4] text-cta-dark text-sm font-semibold tracking-wide rounded-2xl hover:border-whatsapp hover:text-whatsapp transition-all"
          >
            <svg class="w-4.5 h-4.5 text-whatsapp" fill="currentColor" viewBox="0 0 24 24">
