      ...
      <div class="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            >
              Farm fresh to your door. Quality produce and groceries delivered with care.
            </p>
            <%!-- Delivery info badges --%>
            <div class="flex flex-wrap gap-2">
              <span class="inline-flex items-center gap-1.5 px-3 py-1.5 bg-[#ECFDF5] text-[#059669] text-xs font-semibold rounded-full">
                <svg
                  class="w-3.5 h-3.5"
                  fill="none"
                  stroke="currentColor"
