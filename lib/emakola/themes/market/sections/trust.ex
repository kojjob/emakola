defmodule Emakola.Themes.Market.Sections.Trust do
  @moduledoc """
  Market home commerce trust strip — the payment rails the platform really
  supports (Paystack Ghana mobile money: MTN MoMo, Telecel Cash, AirtelTigo
  Money, plus card), secure checkout, and where delivery/returns and support
  actually live.
