      ...
      <div class="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16 sm:h-20">
          ...
          <nav class="hidden md:flex items-center gap-8 text-sm font-medium text-[#1F2937]">
            <a href={"/@#{@store.slug}"} class="hover:text-[#14543E] transition-colors">Home</a>
            <a href={"/@#{@store.slug}/products"} class="hover:text-[#14543E] transition-colors">
              Products
            </a>
            <a
            ...
            <a href={"/@#{@store.slug}/about"} class="hover:text-[#14543E] transition-colors">
              About
            </a>
            <a href={"/@#{@store.slug}/contact"} class="hover:text-[#14543E] transition-colors">
              Contact
            </a>
          </nav>
