  ...
  def nav(assigns) do
    ...
    <header class="sticky top-0 z-50 bg-[#FBF9F5]/85 backdrop-blur border-b border-[#ECE7DE]">
      <div class="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16">
        <a href={"/@#{@store.slug}"} class="spot-heading text-lg font-extrabold tracking-tight">
          {@store.name}
        </a>
        <nav class="hidden md:flex items-center gap-7 text-sm text-[#6B675F]">
          <a href={"/@#{@store.slug}/products"} class="hover:text-[#16130F]">Product</a>
      ...
      <div class="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 py-12 grid grid-cols-2 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul class="space-y-2 text-sm text-[#6B675F]">
            <li>
              <a href={"/@#{@store.slug}/products"} class="hover:text-[#16130F]">The product</a>
            </li>
            <li><a href={"/@#{@store.slug}/cart"} class="hover:text-[#16130F]">Cart</a></li>
          </ul>
        </div>
        <div>
          <h4 class="text-xs font-semibold uppercase tracking-wider mb-3">More</h4>
          <ul class="space-y-2 text-sm text-[#6B675F]">
            <li><a href={"/@#{@store.slug}/about"} class="hover:text-[#16130F]">About</a></li>
            <li><a href={"/@#{@store.slug}/track"} class="hover:text-[#16130F]">Track order</a></li>
          </ul>
        </div>
      </div>
