        ...
        <div class="lg:py-2">
          ...
          <section class="px-4 lg:px-0 py-5 space-y-4" aria-label="Add to cart">
            ...
            <a
              ...
              class="flex items-center justify-center gap-2.5 w-full h-12 border-2 border-whatsapp rounded-full text-sm font-semibold text-whatsapp hover:bg-whatsapp/5 transition-all"
              style="font-family: 'Inter', sans-serif;"
            >
