  ...
  def render(assigns) do
    ...
    <div class="max-w-[1600px] mx-auto px-4 sm:px-6">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
        <div class="bg-white rounded-2xl shadow-sm p-5 hover:shadow-md hover:border-slate-300 transition-all duration-300 cursor-default">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-8">
        <div
          ...
          class="bg-white rounded-2xl shadow-sm p-6 hover:shadow-md hover:border-slate-300 transition-all duration-300 relative"
        >
