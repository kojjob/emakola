...
`
  ...
  var scroll_reveal_default = ScrollReveal;

  // js/hooks/auto_dismiss.js
  var AutoDismiss = {
    mounted() {
      this.timer = setTimeout(() => {
  ...
  var auto_dismiss_default = AutoDismiss;

  // js/hooks/theme_settings.js
  var ThemeSettings = {
    mounted() {
  ...
  var theme_settings_default = ThemeSettings;
  ...
  var liveSocket = new LiveSocket2("/live", Socket, {
    ...
    hooks: { ThemeToggle: theme_toggle_default, Analytics: analytics_default, ScrollReveal: scroll_reveal_default, AutoDismiss: auto_dismiss_default, ThemeSettings: theme_settings_default }
  });
