defmodule EmakolaWeb.AdminDesignConsistencyTest do
  ...
  @swept ~w(dashboard_live.ex admin/product_live/index.ex admin/order_live/index.ex admin/order_live/show.ex admin/inventory_live.ex admin/supplier_live/index.ex admin/supplier_live/show.ex admin/settings_live.ex admin/theme_live.ex)
